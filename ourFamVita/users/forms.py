...
class LoginForm(forms.Form):
    user_email = forms.CharField(label="E-mail",
                                 widget=forms.TextInput(attrs={"placeholder": "ex. pharm@ourfamvita.ac"}))
...
class SignupForm(forms.Form):
    user_email = forms.CharField(label="E-mail", widget=forms.TextInput(attrs={"placeholder": "ex. pharm@ourfamvita.ac"}))
